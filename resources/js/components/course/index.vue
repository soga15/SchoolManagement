      ...
      >
        ...
        >
         ...
         <v-dialog v-model="dialogView" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">VIEW COURSE</v-card-title>
            <v-card-text>
               <v-row>
                  <v-col
                    cols="12"
...
import axios from 'axios'
  ...
  export default {
    ...
    methods: {
      ...
      updateItem(item) 
      {
        axios.put(`api/course/update/${item.id}`, item)
        .then(response=> {
      ...
      storeItem() 
      {
        axios.post('api/course/create', this.editedItem)
        .then(response =>{
          console.log(response)
        }).catch(error =>{
          console.log(error)
      ...
      deleteItemConfirm() 
      {
        axios.delete(`api/course/delete/${this.editedItem.id}`)
        .then(response =>{
          console.log(response)
        }).catch(error =>{
          console.log(error)
