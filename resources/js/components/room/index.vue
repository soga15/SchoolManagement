      ...
      >
        ...
        >
         ...
         <v-dialog v-model="dialogView" max-width="500px">
          <v-card>
            <v-card-title class="text-h5">VIEW ROOM</v-card-title>
            <v-card-text>
               <v-row>
                  <v-col
                    cols="12"
...
import axios from 'axios'
  ...
  export default {
    ...
    methods: {
      ...
      updateItem(item) 
      {
        axios.put(`api/room/update/${item.id}`, item)
        .then(response=> {
      ...
      storeItem() 
      {
        axios.post('api/room/create', this.editedItem)
        .then(response =>{
          console.log(response)
        }).catch(error =>{
          console.log(error)
      ...
      deleteItemConfirm() 
      {
        axios.delete(`api/room/delete/${this.editedItem.id}`)
        .then(response =>{
          console.log(response)
        }).catch(error =>{
          console.log(error)
